...
public class PlanInfoSet : IEnumerable<PlanInfo>
{
    ...
    public IEnumerator<PlanInfo> GetEnumerator()
    {
        return PlanDesignationInfo.GetEnumerator();
    }
    ...
    public void Draw(IntVec3 intVec, Map map)
    {
        ...
        foreach (var item in PlanDesignationInfo)
        {
            ...
            Graphics.DrawMesh(MeshPool.plane10, position, Quaternion.identity, Resources.PlanMatColor[item.Color],
                0);
            list.Add(intVec2);
        }
